...
defimpl Protocols.Functor, for: Branch do
  alias Protocols.Functor
  import Branch
...
defimpl Protocols.Comonad, for: Branch do
  alias Protocols.Comonad
  import Branch
...
defimpl Protocols.Foldable, for: Branch do
  alias Protocols.Foldable
